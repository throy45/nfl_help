...
class Calendar:
    ...
    def __init__(self, current_week):
        ...
        for week_index in range(18):
            ...
            url = "https://www.pro-football-reference.com/years/2021/week_" + str(week_nb) + ".htm"
    ...
    def _update_week_file(self, week_nb):
        ...
        """
        week_nb = str(week_nb)
        url = "https://www.pro-football-reference.com/years/2021/week_" + week_nb + ".htm"
    ...
    def update_week_games(self, week_nb):  # ######## ici
        """
        Adds or updates the games for specified week in the games dict. Currently can only fetch past games.
        :param week_nb: int
        :return:
        """
        url = "https://www.pro-football-reference.com/years/2021/week_" + str(week_nb) + ".htm"
        ...
        # uses Beautiful Soup to parse the html and find the section corresponding to
        # the match
        soup = BeautifulSoup(html, "html.parser")
        rows = soup.select('.game_summary')

        # for every game (16) per week, create an element for that game in self.games
        for game_index in range(16):
            ...
            # convert it to datetime.date element to be able to compare with today's date
